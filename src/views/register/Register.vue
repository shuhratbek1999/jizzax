         ...
         <div class="login_top">
              <div class="login_about">
                  <ul>
                    ...
                    <li style="color: white; margin-top: -10px; font-size: 26px; font-family: sans-serif">Xush kelibsiz!</li>
...
const fakultet = ref([
    {id: 1, label: "Matematika"},
    {id: 2, label: "Axborot texnologiyalari"},
    {id: 3, label: "Ona tili va adabiyot"},
    {id: 4, label: "Jismoniy madaniyat"},
    {id: 5, label: "Tabiiy fanlar"}
])
const yonalish = ref([
    {id: 1, label: "Matematika"},
    {id: 2, label: "Informatika"},
    {id: 3, label: "Ona tili va adabiyot"},
    {id: 4, label: "Jismoniy tarbiya"},
    {id: 5, label: "Mehnat"},
    {id: 6, label: "Huquqshunoslik"},
])
